...
def main(argv):
    ...
    command_format = "\ncommands: [npuzzle] [board file] [sliding/teleporting/ml] [true/false]"
    ...
    while True:
        ...
        if algorithm == COMMAND_ARGUMENT_ASTAR:
            ...
            if not heuristic.lower() in [Algorithm.HEURISTIC_TELEPORT, Algorithm.HEURISTIC_SLIDE, Algorithm.HEURISTIC_ML]:
